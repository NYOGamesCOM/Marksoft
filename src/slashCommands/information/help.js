...
module.exports = {
  ...
  async execute(interaction) {
    ...
    .setTitle(`Marksoft's slash commands`)
    ...
    .addFields(
      ...
      { name: "\u200b", value: "**[Invite](https://invite.Marksoft.ro) | " + "[Support Server](https://Marksoft.ro/support) | " + "[Dashboard](https://Marksoft.ro/dashboard)**" }
    )
    .setColor("GREEN")
