...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      ...
      category: "Moderation",
      usage: "<user> [reason]",
      examples: ["warnpurge @Marksoft 10."],
      guildOnly: true,
      botPermission: [
        "SEND_MESSAGES",
        "EMBED_LINKS",
  ...
  async run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(
        `**${mentionedMember.user.tag}** has been warned, with **${messages.size
        }** messages purged ${success}${logging && logging.moderation.include_reason === "true"
          ? `\n\n**Reason:** ${reason}`
          : ``
        }`
      )
