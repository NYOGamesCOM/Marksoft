      ...
      message.channel
        .sendCustom({
          embeds: [
            new MessageEmbed()
              .setDescription(
                `${success} Slow Mode was successfuly disabled${logging && logging.moderation.include_reason === "true"
                  ? `\n\n**Reason:** ${reason}`
                  : ``
                }`
              )
      ...
      message.channel
        .sendCustom({
          embeds: [
            new MessageEmbed()
              .setDescription(
                `${success} | Slow Mode was successfuly enabled to **1 msg /${rate}s** ${logging && logging.moderation.include_reason === "true"
                  ? `\n\n**Reason:** ${reason}`
                  : ``
                }`
              )
